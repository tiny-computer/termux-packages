...
TERMUX_PKG_SHA256=1f2e36a081cd299173f1c12b64b1cef971063e67bf226fb3f7048f2e67bd6a70
TERMUX_PKG_AUTO_UPDATE=true
TERMUX_PKG_DEPENDS="glib, gpgme,libassuan, libcurl, libgcrypt, libgpg-error, libotr, libsignal-protocol-c, libsqlite, libstrophe, ncurses, python, readline"
