...
TERMUX_PKG_DEPENDS="clang, libandroid-execinfo, libandroid-posix-semaphore, libandroid-shmem, libandroid-sysv-semaphore, libcurl, libuuid, libxml2, libdispatch, llbuild, pkg-config, swift-sdk-${TERMUX_ARCH/_/-}"
