...
TERMUX_PKG_SRCURL=(
	https://github.com/Cateners/virglrenderer-android/archive/61c45d531463d7b34fa7957a90aae41e58dfc865.tar.gz
...
termux_step_host_build() {
	...
	mv $_INSTALL_PREFIX/bin/virgl_test_server $TERMUX_PREFIX/bin/venus_server_android

	# Cleanup.
	mv $_INSTALL_PREFIX/{bin,include,lib/pkgconfig} /tmp
}
