...
TERMUX_PKG_DEPENDS="freetype, game-music-emu, libandroid-spawn, libc++, luajit, libmodplug, libogg, libtheora, libvorbis, libmpg123, openal-soft, opengl, sdl2 | sdl2-compat, zlib"
